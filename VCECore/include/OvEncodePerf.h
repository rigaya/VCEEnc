...
* @file <OvEncodePerf.h>                          
*                                       
* @brief Contains declaration for performance measurement functions
*         
********************************************************************************
*/
#ifndef _OVENCODEPERF_H_
#define _OVENCODEPERF_H_
/*******************************************************************************
*                             INCLUDE FILES                                    *
*******************************************************************************/
#include <windows.h>
...
/*******************************************************************************/
#define MAX_TIMING  64
/*******************************************************************************/
/* This is used to skip the initial number of frames for profiling             */
/*******************************************************************************/
#define SKIP_TIMING 1

typedef struct profile
{
	int64 sTime[MAX_TIMING];     /**< Records the start time of the profiler   */
	int64 accSum[MAX_TIMING];    /**< Accumulates the timer values             */
