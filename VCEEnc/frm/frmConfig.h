...
private: System::Windows::Forms::Label^  fcgLBLSMVert;
private: System::Windows::Forms::NumericUpDown^  fcgNUMVSearchRangeY;


private: System::Windows::Forms::NumericUpDown^  fcgNUMVSearchRangeX;
private: System::Windows::Forms::ComboBox^  fcgCXLSMVert;
...
private: System::Windows::Forms::CheckBox^  fcgCBFMEAdvModeDecision;

private: System::Windows::Forms::Label^  label4;
private: System::Windows::Forms::Label^  fcgLBSubMode;
private: System::Windows::Forms::ComboBox^  fcgCXSubMode;
private: System::Windows::Forms::CheckBox^  fcgCBForceZeroCenter;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->fcgCBForceZeroCenter = (gcnew System::Windows::Forms::CheckBox());
			this->fcgLBSubMode = (gcnew System::Windows::Forms::Label());
			this->fcgCXSubMode = (gcnew System::Windows::Forms::ComboBox());
			this->label4 = (gcnew System::Windows::Forms::Label());
			this->fcgCBFMEAdvModeDecision = (gcnew System::Windows::Forms::CheckBox());
			this->label2 = (gcnew System::Windows::Forms::Label());
			this->fcgLBLSMVert = (gcnew System::Windows::Forms::Label());
			this->fcgNUMVSearchRangeY = (gcnew System::Windows::Forms::NumericUpDown());
			this->fcgNUMVSearchRangeX = (gcnew System::Windows::Forms::NumericUpDown());
			this->fcgCXLSMVert = (gcnew System::Windows::Forms::ComboBox());
			...
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->fcgNUMVSearchRangeY))->BeginInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->fcgNUMVSearchRangeX))->BeginInit();
			...
			this->fcgLBAudioEncTiming->Location = System::Drawing::Point(246, 65);
			...
			this->fcgCXAudioEncTiming->Location = System::Drawing::Point(292, 62);
			...
			this->fcgLBAudioTemp->Location = System::Drawing::Point(18, 250);
			...
			this->fcgCXAudioTempDir->Location = System::Drawing::Point(146, 247);
			...
			// 
			this->fcgTXCustomAudioTempDir->Location = System::Drawing::Point(75, 274);
			...
			// 
			this->fcgBTCustomAudioTempDir->Location = System::Drawing::Point(326, 272);
			...
			this->fcgCBAudioUsePipe->Location = System::Drawing::Point(218, 149);
			...
			this->fcgLBAudioBitrate->Location = System::Drawing::Point(289, 177);
			...
			// fcgNUAudioBitrate
			// 
			this->fcgNUAudioBitrate->Location = System::Drawing::Point(218, 173);
			...
			this->fcgCBAudio2pass->Location = System::Drawing::Point(130, 148);
			...
			this->fcgCXAudioEncMode->Location = System::Drawing::Point(21, 172);
			...
			this->fcgLBAudioEncMode->Location = System::Drawing::Point(10, 152);
			...
			// 
			this->fcgBTAudioEncoderPath->Location = System::Drawing::Point(330, 112);
			...
			this->fcgTXAudioEncoderPath->Location = System::Drawing::Point(21, 114);
			...
			this->fcgLBAudioEncoderPath->Location = System::Drawing::Point(18, 97);
			...
			this->fcgCXAudioPriority->Location = System::Drawing::Point(146, 215);
			...
			this->fcgLBAudioPriority->Location = System::Drawing::Point(19, 218);
			...
			this->tabPageVideoEnc->Controls->Add(this->fcgCBForceZeroCenter);
			this->tabPageVideoEnc->Controls->Add(this->fcgLBSubMode);
			this->tabPageVideoEnc->Controls->Add(this->fcgCXSubMode);
			this->tabPageVideoEnc->Controls->Add(this->label4);
			this->tabPageVideoEnc->Controls->Add(this->fcgCBFMEAdvModeDecision);
			this->tabPageVideoEnc->Controls->Add(this->label2);
			this->tabPageVideoEnc->Controls->Add(this->fcgLBLSMVert);
			this->tabPageVideoEnc->Controls->Add(this->fcgNUMVSearchRangeY);
			this->tabPageVideoEnc->Controls->Add(this->fcgNUMVSearchRangeX);
			this->tabPageVideoEnc->Controls->Add(this->fcgCXLSMVert);
			this->tabPageVideoEnc->Controls->Add(this->fcgCBDeblock);
			this->tabPageVideoEnc->Controls->Add(this->fcggroupBoxDeblock);
			...
			// 
			// fcgCBForceZeroCenter
			// 
			this->fcgCBForceZeroCenter->AutoSize = true;
			this->fcgCBForceZeroCenter->Location = System::Drawing::Point(27, 314);
			this->fcgCBForceZeroCenter->Name = L"fcgCBForceZeroCenter";
			this->fcgCBForceZeroCenter->Size = System::Drawing::Size(142, 18);
			this->fcgCBForceZeroCenter->TabIndex = 14;
			this->fcgCBForceZeroCenter->Tag = L"chValue";
			this->fcgCBForceZeroCenter->Text = L"forceZeroPointCenter";
			this->fcgCBForceZeroCenter->UseVisualStyleBackColor = true;
			// 
			// fcgLBSubMode
			// 
			this->fcgLBSubMode->AutoSize = true;
			this->fcgLBSubMode->Location = System::Drawing::Point(13, 277);
			this->fcgLBSubMode->Name = L"fcgLBSubMode";
			this->fcgLBSubMode->Size = System::Drawing::Size(57, 14);
			this->fcgLBSubMode->TabIndex = 128;
			this->fcgLBSubMode->Text = L"SubMode";
			// 
			// fcgCXSubMode
			// 
			this->fcgCXSubMode->DropDownStyle = System::Windows::Forms::ComboBoxStyle::DropDownList;
			this->fcgCXSubMode->FormattingEnabled = true;
			this->fcgCXSubMode->Location = System::Drawing::Point(153, 274);
			this->fcgCXSubMode->Name = L"fcgCXSubMode";
			this->fcgCXSubMode->Size = System::Drawing::Size(143, 22);
			this->fcgCXSubMode->TabIndex = 13;
			this->fcgCXSubMode->Tag = L"chValue";
			// 
			// label4
			// 
			this->label4->AutoSize = true;
			this->label4->Location = System::Drawing::Point(219, 245);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(13, 14);
			this->label4->TabIndex = 126;
			this->label4->Text = L"x";
			// 
			// fcgCBFMEAdvModeDecision
			// 
			this->fcgCBFMEAdvModeDecision->AutoSize = true;
			this->fcgCBFMEAdvModeDecision->Location = System::Drawing::Point(27, 345);
			this->fcgCBFMEAdvModeDecision->Name = L"fcgCBFMEAdvModeDecision";
			this->fcgCBFMEAdvModeDecision->Size = System::Drawing::Size(154, 18);
			this->fcgCBFMEAdvModeDecision->TabIndex = 15;
			this->fcgCBFMEAdvModeDecision->Tag = L"chValue";
			this->fcgCBFMEAdvModeDecision->Text = L"FME adv mode decision";
			this->fcgCBFMEAdvModeDecision->UseVisualStyleBackColor = true;
			this->fcgCBFMEAdvModeDecision->Visible = false;
			// 
			// label2
			// 
			this->label2->AutoSize = true;
			this->label2->Location = System::Drawing::Point(13, 245);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(103, 14);
			this->label2->TabIndex = 123;
			this->label2->Text = L"MV Search Range";
			// 
			// fcgLBLSMVert
			// 
			this->fcgLBLSMVert->AutoSize = true;
			this->fcgLBLSMVert->Location = System::Drawing::Point(13, 374);
			this->fcgLBLSMVert->Name = L"fcgLBLSMVert";
			this->fcgLBLSMVert->Size = System::Drawing::Size(126, 14);
			this->fcgLBLSMVert->TabIndex = 122;
			this->fcgLBLSMVert->Text = L"Luma Search Window";
			this->fcgLBLSMVert->Visible = false;
			// 
			// fcgNUMVSearchRangeY
			// 
			this->fcgNUMVSearchRangeY->Increment = System::Decimal(gcnew cli::array< System::Int32 >(4) {8, 0, 0, 0});
			this->fcgNUMVSearchRangeY->Location = System::Drawing::Point(238, 243);
			this->fcgNUMVSearchRangeY->Maximum = System::Decimal(gcnew cli::array< System::Int32 >(4) {36, 0, 0, 0});
			this->fcgNUMVSearchRangeY->Name = L"fcgNUMVSearchRangeY";
			this->fcgNUMVSearchRangeY->Size = System::Drawing::Size(59, 21);
			this->fcgNUMVSearchRangeY->TabIndex = 12;
			this->fcgNUMVSearchRangeY->Tag = L"chValue";
			this->fcgNUMVSearchRangeY->TextAlign = System::Windows::Forms::HorizontalAlignment::Right;
			// 
			// fcgNUMVSearchRangeX
			// 
			this->fcgNUMVSearchRangeX->Increment = System::Decimal(gcnew cli::array< System::Int32 >(4) {8, 0, 0, 0});
			this->fcgNUMVSearchRangeX->Location = System::Drawing::Point(154, 243);
			this->fcgNUMVSearchRangeX->Maximum = System::Decimal(gcnew cli::array< System::Int32 >(4) {36, 0, 0, 0});
			this->fcgNUMVSearchRangeX->Name = L"fcgNUMVSearchRangeX";
			this->fcgNUMVSearchRangeX->Size = System::Drawing::Size(59, 21);
			this->fcgNUMVSearchRangeX->TabIndex = 11;
			this->fcgNUMVSearchRangeX->Tag = L"chValue";
			this->fcgNUMVSearchRangeX->TextAlign = System::Windows::Forms::HorizontalAlignment::Right;
			// 
			// fcgCXLSMVert
			// 
			this->fcgCXLSMVert->DropDownStyle = System::Windows::Forms::ComboBoxStyle::DropDownList;
			this->fcgCXLSMVert->FormattingEnabled = true;
			this->fcgCXLSMVert->Location = System::Drawing::Point(154, 371);
			this->fcgCXLSMVert->Name = L"fcgCXLSMVert";
			this->fcgCXLSMVert->Size = System::Drawing::Size(143, 22);
			this->fcgCXLSMVert->TabIndex = 16;
			this->fcgCXLSMVert->Tag = L"chValue";
			this->fcgCXLSMVert->Visible = false;
			// 
			// fcgCBDeblock
			// 
			...
			this->fcgNUDeblockThreshold->Tag = L"chValue";
			...
			this->fcgNUDeblockStrength->Tag = L"chValue";
			...
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->fcgNUMVSearchRangeY))->EndInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->fcgNUMVSearchRangeX))->EndInit();
