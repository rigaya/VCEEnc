...
extern "C"
{
    ...
    *
    *   @brief
    *       Sets cache folder path; folder must exists
    *******************************************************************************
    */
    AMF_CORE_LINK AMF_RESULT        AMF_CDECL_CALL AMFSetCacheFolder(const wchar_t* path);
    ...
    *******************************************************************************
    */
    AMF_CORE_LINK const wchar_t*    AMF_CDECL_CALL AMFGetCacheFolder();
}
