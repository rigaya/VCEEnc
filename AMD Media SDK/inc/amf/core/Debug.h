...
extern "C"
{
    ...
    */
    ...
    class AMFDump : public virtual AMFInterface
    {
    public:
        AMF_DECLARE_IID(0x45be2559, 0x6487, 0x447e, 0xbc, 0x4f, 0x4, 0x52, 0x84, 0x6d, 0xf5, 0xdc);
        virtual const wchar_t* GetDumpBasePath() const = 0;             //  Get application dump base path
        virtual AMF_RESULT SetDumpBasePath(const wchar_t* path) = 0;    //  Set application dump base path
        virtual bool IsInputDumpEnabled() const = 0;
        virtual AMF_RESULT EnableInputDump(bool enabled) = 0;     
        virtual bool IsOutputDumpEnabled() const = 0;
        virtual AMF_RESULT EnableOutputDump(bool enabled) = 0;     
        virtual bool IsPerSessionDumpEnabled() const = 0;
        virtual void EnablePerSessionDump(bool enabled) = 0;      
    };
}
